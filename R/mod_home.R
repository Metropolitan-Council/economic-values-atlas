  ...
  tagList(
    ...
    fluidRow(name = "what",
      column(7,
             ...
             shiny::HTML("<p>An interactive tool exploring the economic values of our region. The economic values are specific to our region and are shaped by our 30-year regional plan. We seek to promote sustainable infrastructure development, a resilient economy, and shared prosperity throughout our region.

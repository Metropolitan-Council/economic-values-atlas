  ...
  tagList(
    ...
    fluidRow(name = "what",
      column(7,
             ...
             shiny::HTML("<p>An interactive tool exploring the economic values of the Twin Cities region. These values are specific to our region and are shaped by our 30-year regional plan. We seek to promote sustainable infrastructure development, a resilient economy, and shared prosperity throughout our region.
                         ...
                         <br><br> Here we have synthesized existing and complex datasources to produce accessible conclusions. This tool allows users to find 'opportunity zones' where economic investments could have disproportionately positive impacts for the future prosperity of our entire region.</p>")
      ),
      column(5,
